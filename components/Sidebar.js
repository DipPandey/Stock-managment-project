...
import { faHome, faList, faSearch, faExternalLinkAlt, faBars } from '@fortawesome/free-solid-svg-icons';
...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    return (
        <>
            ...
            <button
                className="text-white bg-gray-800 p-3 fixed top-0 left-0 z-20 sm:hidden"
            ...
            {/* Sidebar content */}
            <div
                className={`fixed h-screen flex flex-col bg-gray-800 text-white w-60 transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    } sm:translate-x-0`}
            >
                <div className="flex items-center justify-center h-20 border-b border-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-box">
